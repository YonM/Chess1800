 ...
 */
public abstract class MoveStagedGenerator extends AbstractBitboardMoveGen implements MoveGenerator{
    private int captureIndex;
    private int nonCaptureIndex;
    private int ttMove=0;
    // Move generation phases
    private int[] captures = new int[MAX_MOVES *2];
    private int[] nonCaptures = new int[MAX_MOVES *2]; // Stores non captures and underpromotions
